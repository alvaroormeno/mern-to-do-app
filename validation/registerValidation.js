// Function that checks all data to validate
...
const validateRegisterInput = (data) => {
    ...
    return {
        // will return an array with errors which carries any erros from let errors and is valid wich value
        // true or false depends if let erros is empy
        errors,
